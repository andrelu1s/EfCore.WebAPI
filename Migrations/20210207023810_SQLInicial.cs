...
{
    public partial class SQLInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BatalhasHeroisId = table.Column<int>(type: "int", nullable: false),
                    HeroisBatalhasId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatalhaHeroi", x => new { x.BatalhasHeroisId, x.HeroisBatalhasId });
                    table.ForeignKey(
                        name: "FK_BatalhaHeroi_Batalhas_HeroisBatalhasId",
                        column: x => x.HeroisBatalhasId,
                        principalTable: "Batalhas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BatalhaHeroi_Herois_BatalhasHeroisId",
                        column: x => x.BatalhasHeroisId,
                        principalTable: "Herois",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatalhaHeroi_HeroisBatalhasId",
                table: "BatalhaHeroi",
                column: "HeroisBatalhasId");
